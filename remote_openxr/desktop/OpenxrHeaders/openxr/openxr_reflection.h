...
#define XR_LIST_BITS_XrOverlayMainSessionFlagsEXTX(_) _(XR_OVERLAY_MAIN_SESSION_ENABLED_COMPOSITION_LAYER_INFO_DEPTH_BIT_EXTX, 0x00000001)

#define XR_LIST_BITS_XrCompositionLayerImageLayoutFlagsFB(_) _(XR_COMPOSITION_LAYER_IMAGE_LAYOUT_VERTICAL_FLIP_BIT_FB, 0x00000001)
...
#define XR_LIST_BITS_XrPassthroughFlagsFB(_) _(XR_PASSTHROUGH_IS_RUNNING_AT_CREATION_BIT_FB, 0x00000001)
...
#define XR_LIST_BITS_XrDigitalLensControlFlagsALMALENCE(_) _(XR_DIGITAL_LENS_CONTROL_PROCESSING_DISABLE_BIT_ALMALENCE, 0x00000001)
...
#define XR_LIST_STRUCTURE_TYPES_XR_USE_PLATFORM_WIN32(_) _(XrHolographicWindowAttachmentMSFT, XR_TYPE_HOLOGRAPHIC_WINDOW_ATTACHMENT_MSFT)
