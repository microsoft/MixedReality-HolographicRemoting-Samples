...
#define XR_LIST_FUNCTIONS_XR_MSFT_holographic_remoting(_) \
    ...
    _(xrConvertTimestampPlayerToRemoteMSFT)               \
    _(xrConvertTimestampRemoteToPlayerMSFT)

#define XR_LIST_FUNCTIONS_XR_MSFT_holographic_remoting_speech(_) \
...
#define XR_LIST_FUNCTIONS_OPENXR_EXTENSIONS(_, __)                                                                                  \
    ...
    XR_MSFT_holographic_remoting_speech_DEFINED(XR_LIST_FUNCTIONS_XR_MSFT_holographic_remoting_speech, _, __)                       \
